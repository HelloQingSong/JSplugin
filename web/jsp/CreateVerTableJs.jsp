...
<div class="row clearfix" style="width: 100%;padding-top: 5%" >
	<div class="col-lg-offset-1 col-lg-10" style="background-color:white ">
		...
		<div class="col-lg-12 form-group">
			...
			<form method="get" action="/creatVerTableJs">
				<%--输入jsId控件--%>
				...
				<div class="col-lg-12" style="padding: 0%">
					...
					<div class="col-lg-9" style="padding: 0%">
						...
						<div class="col-lg-12" style="padding: 0%">
							<div class="col-lg-12" style="padding: 0%">
								<input name="functionsNeeded" type="checkbox" class="checkbox-inline" value="SetInputContentAndReadOnly" style="margin: 0%"/>
								<span class="text-muted">设置文本框内容与是否只读</span>
							</div>

							<%--参数获取--%>
							<div id="SetInputContentAndReadOnlyParameters" class="col-lg-12" style="padding: 0%;display: none">
								<%--设置文本框的内容与选择是否只读--%>
								<div class="col-lg-12"  >
									<div class="col-lg-3" style="padding: 0%;">
										<h5 class="text-muted">填写文本框内容：</h5>
									</div>
									<div id="addInputContent" >
										<%--设置文本框内容--%>
										<div class="col-lg-4"   id="inputContentNeedValues" style="padding: 0%">
											<input type="text" name="inputContent" class="form-control"/>
										</div>
										<div class="col-lg-1"   id="inputContentNeedValues" style="margin: 0%;margin-top: 0.5%;">
											<input type="hidden" name="isReadOnly" value="false">
											<input type="checkbox" name="isReadOnly" value="true"/>
											<span>只读</span>
										</div>
								...
								<div class="col-lg-12" >
									<div class="col-lg-offset-3" style="padding: 0%" >
										<input  type="button" value="增加" class="btn btn-primary" id="addNewInputContent" />
									...
									<script type="text/javascript">
                                        jQuery(document).ready(function () {
                                            jQuery("#addNewInputContent").click(function () {
                                                var id = jQuery("#deleteId").val();
                                                var newStyle = jQuery("#addInputContent").html();
                                                newStyle =  "<div class=\"col-lg-12\" style=\"padding: 0%;\" id='inputContent"+id+"'>"+
                                                    "<div class=\"col-lg-3\" style=\"padding: 0%;\"></div>" +
                                                    newStyle + "<button type='button' class='btn btn-default'onclick=\"deleteInputStyle('inputContent"+id+"')\">删除</button> "
                                                "</div>";

                                                var before = jQuery("#addInputContent").parent();
                                                jQuery(before).append(newStyle);
